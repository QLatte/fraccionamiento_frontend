...
function GateStationPage() {
  ...
  return <div className="gate-station-page"><header className="gate-station-header"><Brand href="/caseta"/><span>Equipo de caseta</span>{identity && <Button className="secondary small-button" onClick={() => void logout().catch(() => {})}><LogOut size={15}/> Cerrar sesión</Button>}</header><main><Gate/></main></div>;
}
